 ...
 * should pass validation by configuring the validation options. For example,
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * configures the validator to only pass American Express and Visa cards. If a
 * card type is not directly supported by this class, you can implement the
 * CreditCardType interface and pass an instance into the
 ...
 * @since Validator 1.1
 * @deprecated Use the new CreditCardValidator in the routines package. This
...
public class CreditCardValidator {
	 ...
	 * 
	 * @param options
	 *            Pass in CreditCardValidator.VISA + CreditCardValidator.AMEX to
	 *            specify that those are the only valid card types.
	 */
	...
	/**
	 * Adds an allowed CreditCardType that participates in the card validation
	 * algorithm.
	 * 
	 * @param type
